...
void Bird::draw() {
    if (x<X_INIT){
        ...
        al_draw_rotated_bitmap(bird1,width/2,height/2,x+width/2,y+height/2,rotation,0);
    } else {
...
void Bird::loop_animation(int type){
    if (type == 1){
        ...
        if (vy<0){
            ...
            if((frames <= contB) && (valueB == 1)){
                al_draw_rotated_bitmap(bird2,width/2,height/2,x+width/2,y+height/2+2,rotation,0);
            ...
            if((frames <= contB) && (valueB == 2)){
                al_draw_rotated_bitmap(bird3,width/2,height/2,x+width/2,y+height/2+4,rotation,0);
                if(frames == contB){
                    contB = contB + TIME_GIF_BIRD;
                    valueB++;
                }
